...
/**
 * Renders the site footer with navigation links and the current year.
 *
 * Displays copyright information and links to privacy policy, terms of service,
 * GitHub, and Devpost pages.
 */
